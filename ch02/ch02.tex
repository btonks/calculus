...
Mathematical theorems are often like cars. I own a Honda Fit that is about as bare-bones as you can get
...
We will develop the luxury features one at a time.

\subsubsection{Multiple applications of the rule}
...
The proof that this always works can be broken down into two steps.
...
This form is stronger, because in a case like example \ref{eg:lhospital-differentiating-twice},
...
than the one on p.~\pageref{lhospital-simple}. Say we only know how to do limits of the form $x\rightarrow0$ rather than
...
proved l'H\^{o}pital's rule. It turns out that l'H\^{o}pital's rule applies to examples like this as
well.
