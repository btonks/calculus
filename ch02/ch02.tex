...
L'H\^{o}pital's rule
also works when the numerator and denominator both blow up to infinity at a particular point.
...
and bottom gives $(-x^{-2})/(-2x^{-2})\rightarrow 1/2$. We can see that the reason the rule
