...
rational numbers, a particular subset of the reals, that that means that it can't be
...
(c) Split the sum into two sums, one for the 1103 term and one for the $26390k$. The ratio of the two factorials is always less than $4^{4k}$, so
